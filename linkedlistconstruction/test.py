...
class TestProgram(unittest.TestCase):
    def test_case_1(self):
        ...
        print('linkedList = program.DoublyLinkedList()')
        one = Node(1)
        two = Node(2)
        three = Node(3)
        three2 = Node(3)
        ...
        print('linkedList.insertBefore(six, three)')
        ...
        print('linkedList.insertAfter(six, three2)')
        ...
        print('linkedList.insertAtPosition(1, three3)')
